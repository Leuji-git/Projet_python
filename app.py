...
class RandomMovieApp:
    def __init__(self, master, tmdb_client):
        ...
        self.page = tk.Entry(self.filters_frame, width=5, font=bellerose)
        self.page.grid(row=0, column=3, padx=5)
        self.page.insert(0, "20")
        ...
        #DETAIL FILM 
        self.details_frame = tk.Frame(self.result_frame, bg='#FFFFFF')
        self.details_frame.grid(row=0, column=1, padx=10, pady=10, sticky='n')

        # Label Affiche du Film
        self.poster_label = tk.Label(self.result_frame, bg='#212F3D',fg="#212F3D")
        self.poster_label.grid(row=0, column=0, rowspan=5, padx=10, pady=10)
        self.load_default_logo()

        # Label Titre du film
        self.title_label = tk.Label(self.details_frame, text="", font=bellerose_title, fg="#212F3D", bg='#FFFFFF')
        self.title_label.grid(row=0, column=0, sticky='w')

        # Label Date du film
        self.release_date_label = tk.Label(self.details_frame, text="", font=bellerose_bold, fg="#212F3D", bg='#FFFFFF')
        self.release_date_label.grid(row=1, column=0, sticky='w')

        # Label note TMDB
        self.vote_average_label = tk.Label(self.details_frame, text="", font=bellerose_bold, fg="#212F3D", bg='#FFFFFF')
        ...
        # Description du film
        self.overview_label = tk.Label(self.result_frame, text="", font=bellerose, fg="#212F3D", bg='#FFFFFF', wraplength=400, justify="left")
